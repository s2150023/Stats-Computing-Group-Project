...
National Electricity System Operator (NESO) is responsible for managing electricity supply and demand across Great Britain (GB). For effective long-term planning of electricity infrastructure, NESO requires reliable forecasts of future electricity demand, especially during peak periods. This project aims to develop a linear regression model to simulate future daily peak demand scenarios, with a particular focus on winter periods when demand is highest and the risk of electricity shortfalls is greatest.

The model will help NESO quantify uncertainty in future peak demand patterns, considering factors such as weather conditions, seasonal variations, day-of-week effects, and long-term trends. We will analyze how these factors influence daily peak demand at 6 pm, when demand typically reaches its maximum. Our goal is to create a model that accurately predicts high-demand scenarios, especially in the upper tail of the demand distribution, to inform infrastructure planning decisions and support security of supply analysis.
